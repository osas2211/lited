...
export const ReImagine = () => {
  ...
  return (
    <div className="pt-[2rem] relative" id="re-imagine">
      <div className="grid md:grid-cols-6 relative">
        <div className="md:h-[450px] md:mb-0 mb-[-8.7rem] w-full md:bg-green-900 sticky z-[1] md:top-[80px] top-[420px] bottom-[230rem] md:left-[0px] left-[1.5rem] text-center flex items-center justify-center">
