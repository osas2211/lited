...
export const Details = () => {
  ...
  const tabItems = [
    { heading: "info", element: <InfoTab /> },
    { heading: "track", element: <TrackTab /> },
    { heading: "owners", element: <OwnersTab /> },
    ...
    <div className="md:w-[400px] h-full md:h-[600px] bg-grey-1000 md:rounded-r-[28px] p-[20px] md:pb-[20px] pb-[5rem] relative">
      <div className="md:max-h-[508px] overflow-y-scroll no-scrollbar">
        <div className="flex justify-between">
          <Subtitle2Medium>NFT // #1 OF 1</Subtitle2Medium>

          {/* Copy, share..... */}
          <Actions />
        </div>
        <H5 className="mb-[12px] mt-[16px]">Name of the NFTree</H5>
